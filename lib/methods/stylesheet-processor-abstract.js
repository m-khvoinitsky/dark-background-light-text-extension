...
// http://www.wsj.com/articles/why-apple-should-kill-off-the-mac-1434321848 — bad colors
// http://www.opennet.ru/opennews/art.shtml?num=42453 — bad color, again
var StylesheetProcessorAbstract = Class({
    ...
    process: function process() {
        ...
        if (this.url != this.window.document.documentURI) {
