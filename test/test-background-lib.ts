...
const csp_test_data = [
  ...
  [
    'style-src https://example.com data:',
    "style-src https://example.com data: 'unsafe-inline'",
  ],
  [
    "style-src https://example.com 'unsafe-inline'",
    "style-src https://example.com 'unsafe-inline'",
  ...
  [
    "default-src https://example.com 'unsafe-inline'",
    "default-src https://example.com 'unsafe-inline'",
  ],
  ...
  [
    ...
    "default-src https://example.com; style-src https://example.com 'unsafe-inline'",
  ],
];
